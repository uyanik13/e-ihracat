				...
				<div class="container team-boxes">
					...
					<div class="cell-4 fx" data-animate="bounceIn">
						<div class="team-box">
							<div class="team-img">
								<img alt=""
									src="https://eihracatturkiye.com/wp-content/uploads/2020/06/tuger-akkaya.png">
								<h3>Tuğer Akkaya</h3>
							</div>
							<div class="team-details">
								<h3>Tuğer Akkaya</h3>
								<div class="t-position">Başkan Yardımcısı</div>
								<div class="team-socials">
									<ul>
										<li><a class="teamLinkedin" href="#" title="linkedin"><span
					...
					<div class="cell-4 fx" data-animate="bounceIn" data-animation-delay="200">
						<div class="team-box">
							<div class="team-img">
								<img alt=""
									src="https://eihracatturkiye.com/wp-content/uploads/2020/06/deren-karaca.png">
								<h3>Deren Karaca</h3>
							</div>
							<div class="team-details">
								<h3>Deren Karaca</h3>
								<div class="t-position">Yönetim Kurulu Üyesi</div>
								<div class="team-socials">
									<ul>
										<li><a class="teamLinkedin" href="#" title="linkedin"><span
													class="fa fa-linkedin"></span></a></li>
					...
					<div class="cell-4 fx" data-animate="bounceIn" data-animation-delay="400">
						<div class="team-box">
							<div class="team-img">
								<img alt=""
									src="https://eihracatturkiye.com/wp-content/uploads/2020/05/tunc-berkman.001.jpeg">
								<h3>Tunç Berkman</h3>
							</div>
							<div class="team-details">
								<h3>Tunç Berkman</h3>
								<div class="t-position">Pazarlamadan Sorumlu Başkan Yardımcısı</div>
								<div class="team-socials">
									<ul>
										<li><a class="teamLinkedin" href="#" title="linkedin"><span
													class="fa fa-linkedin"></span></a></li>
