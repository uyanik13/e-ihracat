							    ...
							    <nav class="top-nav mega-menu">
								    <ul>
								      <li><a href="#"><i class="fa fa-home"></i><span>Home</span></a>
									      <ul>
										      <li><a href="anasayfa.blade.php">Home Version 1</a></li>
								      ...
								      <li class="selected"><a href="#"><i class="fa fa-key"></i><span>Features</span></a>
								      	<ul>
										      ...
										      <li><a href="#"><i class="fa fa-bars"></i>Menu Styles</a>
										      		<ul>
										      			<li><a href="anasayfa.blade.php">Default Menu</a></li>
										      ...
										      <li><a href="#"><i class="fa fa-bars"></i>Sub Menu Styles</a>
										      		<ul>
										      			<li><a href="anasayfa.blade.php">Default Sub Menu</a></li>
										      ...
										      <li class="selected"><a href="#"><i class="fa fa-phone"></i>Contact Pages</a>
										      	<ul>
										      		<li><a href="contact.blade.php">Contact 1 HTML</a></li>
								      ...
								      <li><a href="#"><i class="fa fa-book"></i><span>Blog</span></a>
										      ...
										      <li><a href="#">Blog Large Image</a>
										      		<ul>
										      			<li><a href="blog.blade.php">Right Side Bar</a></li>
										      ...
										      <li><a href="#">Blog Single</a>
										      		<ul>
										      			<li><a href="../components/detail_components/blog-single.blade.php">Right Side Bar</a></li>
					    ...
					    <div class="row">
						    ...
						    <div class="cell-3">
							    ...
							    <ul class="footer-menu">
								    <li><a href="anasayfa.blade.php">Home Page</a></li>
								    <li><a href="about-us.blade.php">About Us</a></li>
								    <li><a href="blog.blade.php">Our Blog</a></li>
					    	...
					    	<div class="cell-3">
							    ...
							    <ul>
								    ...
								    <li class="footer-contact"><i class="fa fa-map-marker"></i><span><a href="contact.blade.php#map_canvas">View our map</a></span></li>
							    </ul>
						    </div>
