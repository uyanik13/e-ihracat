		...
		ajaxSubmit:function($this,action){
			...
			$.post(action, $('#cform').serialize(),
				function(data){
					...
					$('#message').html('<div class="cont-success center"><i class="fa fa-smile-o success-icon"></i><p class="congrats">Thank You!</p><p class="congratsTxt">Your message was successfuly sent , We will get back to you very soon, if you need to browse our site just click the link below.</p><div><a href="index.html" class="btn btn-large main-bg">Go to home page</a></div></div>');
